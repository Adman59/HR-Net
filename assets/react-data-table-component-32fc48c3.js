...
`,Tn=p.div`
	...
	white-space: nowrap;
	text-overflow: ellipsis;
`;var Ln=n.memo(function({column:e,disabled:t,draggingColumnId:o,selectedColumn:a={},sortDirection:l,sortIcon:i,sortServer:s,pagination:g,paginationServer:b,persistSelectedOnSort:y,selectableRowsVisibleOnly:u,onSort:w,onDragStart:j,onDragOver:R,onDragEnd:f,onDragEnter:D,onDragLeave:x}){n.useEffect(()=>{typeof e.selector=="string"&&console.error(`Warning: ${e.selector} is a string based column selector which has been deprecated as of v7 and will be removed in v8. Instead, use a selector function e.g. row => row[field]...`)},[]);const[P,H]=n.useState(!1),S=n.useRef(null);if(n.useEffect(()=>{S.current&&H(S.current.scrollWidth>S.current.clientWidth)},[P]),e.omit)return null;const E=()=>{if(!e.sortable&&!e.selector)return;let $=l;be(a.id,e.id)&&($=l===X.ASC?X.DESC:X.ASC),w({type:"SORT_CHANGE",sortDirection:$,selectedColumn:e,clearSelectedOnSort:g&&b&&!y||s||u})},L=$=>n.createElement(Hn,{sortActive:$,sortDirection:l}),A=()=>n.createElement("span",{className:[l,"__rdt_custom_sort_icon__"].join(" ")},i),C=!(!e.sortable||!be(a.id,e.id)),v=!e.sortable||t,U=e.sortable&&!i&&!e.right,M=e.sortable&&!i&&e.right,N=e.sortable&&i&&!e.right,Q=e.sortable&&i&&e.right;return n.createElement(Fn,{"data-column-id":e.id,className:"rdt_TableCol",$headCell:!0,allowOverflow:e.allowOverflow,button:e.button,compact:e.compact,grow:e.grow,hide:e.hide,maxWidth:e.maxWidth,minWidth:e.minWidth,right:e.right,center:e.center,width:e.width,draggable:e.reorder,$isDragging:be(e.id,o),onDragStart:j,onDragOver:R,onDragEnd:f,onDragEnter:D,onDragLeave:x},e.name&&n.createElement(In,{"data-column-id":e.id,"data-sort-id":e.id,role:"columnheader",tabIndex:0,className:"rdt_TableCol_Sortable",onClick:v?void 0:E,onKeyPress:v?void 0:$=>{$.key==="Enter"&&E()},sortActive:!v&&C,disabled:v},!v&&Q&&A(),!v&&M&&L(C),typeof e.name=="string"?n.createElement(Tn,{title:P?e.name:void 0,ref:S,"data-column-id":e.id},e.name):e.name,!v&&N&&A(),!v&&U&&L(C)))});const An=p(de)`
	flex: 0 0 48px;
	justify-content: center;
	align-items: center;
	user-select: none;
